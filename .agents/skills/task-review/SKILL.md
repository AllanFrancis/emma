...
1. Search for task files matching the pattern `*_task.md` in the project (check `tasks/`, `.Codex/tasks/`, `docs/tasks/`, or the project root).
...
3. Verify compliance with AGENTS.md and applicable skills.
