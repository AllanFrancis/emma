...
- [x] Leitura humana confirma que as correções do contrato v2 não pioraram em tato nem em sobre-correção frente ao v3 | evidence: manual @allan (2026-09-16 16:36, commit `01c70a4`)
