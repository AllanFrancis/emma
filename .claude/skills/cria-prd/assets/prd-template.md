...
- Requisitos funcionais numerados globalmente como RF-01, RF-02, ... (numeração ÚNICA em todo o documento — nunca reiniciada por seção; esses IDs são usados pelo QA, pelos bugs e pela rastreabilidade de critérios)]
